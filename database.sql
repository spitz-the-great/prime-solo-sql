-- 1.	Get all users from Chicago.
	SELECT "username" FROM "accounts" WHERE "city" ILIKE 'chicago';
    ...
    "account_balance")
    VALUES( 20, 'genji', 'hanamura', 0, 0, 0);
	...
	SELECT * FROM "accounts" WHERE ("city" LIKE 'miami' OR "city" LIKE 'phoenix') AND  ("transactions_completed" < 5);
